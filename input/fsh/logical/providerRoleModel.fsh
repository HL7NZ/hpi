...
* provider 1..1 Reference(ProviderModel) "The provider"
* organization 0..1 Reference(OrganizationModel) "The organization that the provide is working for"
* facility 0..1 Reference(FacilityModel) "The facility where the provider provides care"
...
* creator 0..1 BackboneElement "The person who created or updated this resource"
  * person 1..1 Reference(ProviderModel) "The person making the change"
  * organization 0..1 Reference(OrganizationModel) "The organization they are working on behalf on"
