...
* alias 0..* BackboneElement "Other names by which this facility is known"
  ...
  * type from https://nzhts.digital.health.nz/fhir/ValueSet/alias-type-code
...
* typeOfFunction 0..1 CodeableConcept "The kinds of function that can be performed at this facility"

* contactDetails 0..* ContactPoint "How to contact the facility (by a human)"
* electronicContactDetails 0..* EndpointModel "Technical contacts"
* address 0..1 Address "Where the facility is located"
* managingOrganization 0..1 OrganizationModel "The organization responsible for this facility"
* partOf 0..1 FacilityModel "If this facility is part of a larger one (eg a ward in a hospital"
...
* dhb from https://nzhts.digital.health.nz/fhir/ValueSet/dhb-code
