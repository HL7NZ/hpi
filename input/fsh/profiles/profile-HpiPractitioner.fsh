...
* qualification.extension[scope-of-practice].extension[code].valueCodeableConcept from https://standards.digital.health.nz/ns/practitioner-scope-of-practice-code|2.1.0 (preferred)
