...
E.g. GET (...)/organization?name=TryNSave Pharmacy
...
GET (...)/Organization?identifier=https://standards.digital.health.nz/ns/hpi-nzbn | 9999999999001

**LegacyOrgId**
* Search Organization by identifier Legacy organization id

GET (...)/Organization?identifier=https://standards.digital.health.nz/ns/nzhis-agency-id | 9000

**Address** 
* Search Organization by address

GET (...)/Organization?address=Thorndon
