...
* Scenarios
  * A new practitioner starts at a new organization and their HPI identity details and practicing credentials are checked.
...
* Steps involved for an RA adding a new practitioner to the HPI
  ...
  * If not found, the user provides the details to be added to the HPI:
    ...
    * Death date and registration details (qualification) provided subsequently with an update operation
...
* Scenarios:
  ...
  * An RA wants to add a registration (qualification) after a practitioner has been created, or update registration details (qualification)
...
* The operations have been broken down into four custom updates:
  ...
  * Registration details (qualification)
...
* Steps involved to retrieve all the PractitionerRole records for a Practitioner
  ...
  * The Integrating application returns a bundle of Practitioner Role records
...
* Steps involved:
  ...
  * The HPI confirms a successful add and returns the hpi-practitionerrole-id and a version-id
...
* Steps involved:
  ...
  * The HPI returns the updated version-id
