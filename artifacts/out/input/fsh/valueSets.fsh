...
Id: Hpi_country_code_iso_3166_1
...
Id: Hpi_additional_authorisation
...
ValueSet: Hpi_ContactPointSystem
Id: Hpi_ContactPointSystem
Title: "Use values for a ContactSystem"
Description: "System values for a ContactPoint"
* ^meta.profile[0] = "http://hl7.org/fhir/StructureDefinition/shareablevalueset"
* ^url = "https://standards.digital.health.nz/fhir/ValueSet/hpi-contact-point-system-code"
* ^version = "1.0"
* ^status = #active
...
Id: Hpi_organization_alias_type
...
Id: Hpi_practitioner_role_status_reason
...
Id: Hpi_registration_type_legacy
...
Description: "A coded type for a name prefix or title eg Mr, Mrs, Dr."
* ^meta.profile[0] = "http://hl7.org/fhir/StructureDefinition/shareablevalueset"
...
* ^compose.inactive = true
* include codes from system https://standards.digital.health.nz/ns/name-prefix-code|1.0
...
ValueSet: Identifier_Type_Codes
Id: identifier-type
